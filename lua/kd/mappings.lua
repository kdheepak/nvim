...
nnoremap("<leader>qf", "<cmd>JuliaFormatterFormat<CR>", { desc = "Format Julia file" })
nnoremap("<leader>qq", "<cmd>lua require('fzf-lua').quickfix()<CR>", { desc = "Quickfix" })
...
nnoremap("<leader>v:", "<cmd>FzfLua commands<CR>", { desc = "Vim commands" })
